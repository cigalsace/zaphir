...
def convert_xls2xml(xls_file, xml_dir):
    ...
    _, ext = os.path.splitext(xls_file)
    # Si extention de xls_file == 'xls'
    if ext == '.xls':
        _get_value = _get_xls_value
    ...
    # Sinon _get_value = _get_xlsx_value
    elif ext == '.xlsx':
        _get_value = _get_xlsx_value
        ...
        for s in cellnames:
            if s in sh_list:
                sh[s] =  wb.get_sheet_by_name(s)
            else:
                print "La Feuille " + str(s) + " n'existe pas."

        # Liste des cellules nommées dans le fichier MS Excel
        lst_name = wb.get_named_ranges()
    ...
    # MD_FileIdentifier
    e, MD_FileIdentifier = _get_value('md_fileidentifier', lst_name, sh, 'string')
    # e, MD_FileIdentifier = _get_value2(sh, cellname.md_fileidentifier, 'string')
    ...
    e, MD_Language = _get_value('md_language', lst_name, sh, 'string')
    ...
    # MD_CharacterSet
    e, MD_CharacterSet = _get_value('md_characterset', lst_name, sh, 'string')
    ...
    e, MD_HierarchyLevel = _get_value('md_hierarchylevel', lst_name, sh, 'string')
    ...
    for i in range(1, 20):
        e, MD_CntName = _get_value('md_cnt'+str(i)+'_name', lst_name, sh, 'string')
        MD_CntName = _encodexml(MD_CntName)
        e, MD_CntFunction = _get_value('md_cnt'+str(i)+'_fct', lst_name, sh, 'string')
        MD_CntFunction = _encodexml(MD_CntFunction)
        e, MD_CntOrganism = _get_value('md_cnt'+str(i)+'_org', lst_name, sh, 'string')
        MD_CntOrganism = _encodexml(MD_CntOrganism)
        e, MD_CntAddress = _get_value('md_cnt'+str(i)+'_address', lst_name, sh, 'string')
        MD_CntAddress = _encodexml(MD_CntAddress)
        e, MD_CntPostalCode = _get_value('md_cnt'+str(i)+'_cp', lst_name, sh, 'integer')
        e, MD_CntCity = _get_value('md_cnt'+str(i)+'_city', lst_name, sh, 'string')
        e, MD_CntPhone = _get_value('md_cnt'+str(i)+'_tel', lst_name, sh, 'string')
        e, MD_CntEmail = _get_value('md_cnt'+str(i)+'_email', lst_name, sh, 'string')
        MD_CntEmail = _encodexml(MD_CntEmail)
        e, MD_CntRole = _get_value('md_cnt'+str(i)+'_role', lst_name, sh, 'string')
    ...
    # MD_DateStamp
    e, MD_DateStamp = _get_value('md_datestamp', lst_name, sh, 'date')
    if MD_DateStamp:
    ...
    # MD_StandardName
    e, MD_StandardName = _get_value('md_standardname', lst_name, sh, 'string')
    ...
    # MD_StandardVersion
    e, MD_StandardVersion = _get_value('md_standardversion', lst_name, sh, 'string')
    ...
    for i in range(1, 20):
        e, Data_ReferenceSystem = _get_value('data_referencesystem'+str(i), lst_name, sh, 'string')
    ...
    # Data_Title
    e, Data_Title = _get_value('data_title', lst_name, sh, 'string')
    ...
    for type in DateType:
        e, Data_Date = _get_value('data_date'+type, lst_name, sh, 'date')
    ...
    e, Data_PresentationForm = _get_value('data_presentationform', lst_name, sh, 'string')
    ...
    for i in range(1, 20):
        e, Data_Code = _get_value('data_code'+str(i), lst_name, sh, 'string')
        Data_Code = _encodexml(Data_Code)
        e, Data_CodeSpace = _get_value('data_codespace'+str(i), lst_name, sh, 'string')
    ...
    # Data_Abstract
    e, Data_Abstract = _get_value('data_abstract', lst_name, sh, 'string')
    ...
    for i in range(1, 20):
        e, Data_CntName = _get_value('data_cnt'+str(i)+'_name', lst_name, sh, 'string')
        Data_CntName = _encodexml(Data_CntName)
        e, Data_CntFunction = _get_value('data_cnt'+str(i)+'_fct', lst_name, sh, 'string')
        Data_CntFunction = _encodexml(Data_CntFunction)
        e, Data_CntOrganism = _get_value('data_cnt'+str(i)+'_org', lst_name, sh, 'string')
        Data_CntOrganism = _encodexml(Data_CntOrganism)
        e, Data_CntLogo = _get_value('data_cnt'+str(i)+'_logo', lst_name, sh, 'string')
        Data_CntLogo = _encodexml(Data_CntLogo)
        e, Data_CntAddress = _get_value('data_cnt'+str(i)+'_address', lst_name, sh, 'string')
        Data_CntAddress = _encodexml(Data_CntAddress)
        e, Data_CntPostalCode = _get_value('data_cnt'+str(i)+'_cp', lst_name, sh, 'integer')
        e, Data_CntCity = _get_value('data_cnt'+str(i)+'_city', lst_name, sh, 'string')
        e, Data_CntPhone = _get_value('data_cnt'+str(i)+'_tel', lst_name, sh, 'string')
        e, Data_CntEmail = _get_value('data_cnt'+str(i)+'_email', lst_name, sh, 'string')
        Data_CntEmail = _encodexml(Data_CntEmail)
        e, Data_CntRole = _get_value('data_cnt'+str(i)+'_role', lst_name, sh, 'string')
    ...
    e, Data_MaintenanceFrequency = _get_value('data_maintenancefrequency', lst_name, sh, 'string')
    ...
    # Data_BrowseGraphic
    for i in range(1, 20):
        e, Data_BrowseGraphic_Name = _get_value('data_browsegraphic'+str(i)+'_filename', lst_name, sh, 'string')
        Data_BrowseGraphic_Name = _encodexml(Data_BrowseGraphic_Name)
        e, Data_BrowseGraphic_Description = _get_value('data_browsegraphic'+str(i)+'_description', lst_name, sh, 'string')
    ...
    for i in range(1, 20):
        e, Data_Keyword = _get_value('data_keyword'+str(i), lst_name, sh, 'string')
        Data_Keyword = _encodexml(Data_Keyword)
        e, Data_KeywordType = _get_value('data_keyword'+str(i)+'_type', lst_name, sh, 'string')
        if Data_KeywordType: Data_KeywordType = Data_KeywordType.split()[0]
        e, Data_ThesaurusName = _get_value('data_keyword'+str(i)+'_thesaurusname', lst_name, sh, 'string')
        Data_ThesaurusName = _encodexml(Data_ThesaurusName)
        e, Data_ThesaurusDateCreation = _get_value('data_keyword'+str(i)+'_thesaurusdatecreation', lst_name, sh, 'date')
        e, Data_ThesaurusDatePublication = _get_value('data_keyword'+str(i)+'_thesaurusdatepublication', lst_name, sh, 'date')
        e, Data_ThesaurusDateRevision = _get_value('data_keyword'+str(i)+'_thesaurusdaterevision', lst_name, sh, 'date')
    ...
    for i in range(1, 20):
        e, Data_InspireKeyword = _get_value('data_inspirekeyword'+str(i), lst_name, sh, 'string')
    ...
    for i in range(1, 20):
        e, Data_UseLimitation = _get_value('data_uselimitation'+str(i), lst_name, sh, 'string')
    ...
    for i in range(1, 20):
        e, Data_AccessConstraints = _get_value('data_accessconstraints'+str(i), lst_name, sh, 'string')
    ...
    for i in range(1, 20):
        e, Data_UseConstraints = _get_value('data_useconstraints'+str(i), lst_name, sh, 'string')
    ...
    for i in range(1, 20):
        e, Data_OtherConstraints = _get_value('data_otherconstraints'+str(i), lst_name, sh, 'string')
    ...
    e, Data_Classification = _get_value('data_classification', lst_name, sh, 'string')
    ...
    e, Data_SpatialRepresentationType = _get_value('data_spatialrepresentationtype', lst_name, sh, 'string')
    ...
    e, Data_ScaleDenominator = _get_value('data_scaledenominator', lst_name, sh, 'integer')
    e, Data_ScaleDistance = _get_value('data_scaledistance', lst_name, sh, 'integer')
    ...
    for i in range(1, 20):
        e, Data_Language = _get_value('data_language'+str(i), lst_name, sh, 'string')
    ...
    # Data_CharacterSet
    e, Data_CharacterSet = _get_value('data_characterset', lst_name, sh, 'string')
    ...
    for i in range(1, 20):
        e, Data_TopicCategory = _get_value('data_topiccategory'+str(i), lst_name, sh, 'string')
    ...
    for i in range(1, 20):
        e, Data_ExtentName = _get_value('data_ext'+str(i)+'_name', lst_name, sh, 'string')
        Data_ExtentName = _encodexml(Data_ExtentName)
        e, Data_ExtentNorthbound = _get_value('data_ext'+str(i)+'_n', lst_name, sh, 'string')
        e, Data_ExtentSouthbound = _get_value('data_ext'+str(i)+'_s', lst_name, sh, 'string')
        e, Data_ExtentEastbound = _get_value('data_ext'+str(i)+'_e', lst_name, sh, 'string')
        e, Data_ExtentWestbound = _get_value('data_ext'+str(i)+'_w', lst_name, sh, 'string')
    ...
    # Data_TemporalExtent
    for i in range(1, 20):
        e, Data_TemporalExtent_Start = _get_value('data_temporalextent'+str(i)+'_start', lst_name, sh, 'date')
        e, Data_TemporalExtent_End = _get_value('data_temporalextent'+str(i)+'_end', lst_name, sh, 'date')
        e, Data_ExtentName = _get_value('data_temporalextent'+str(i)+'_description', lst_name, sh, 'string')
        Data_ExtentName = _encodexml(Data_ExtentName)
    ...
    # Data_VerticalExtent
    for i in range(1, 20):
        e, Data_VerticalExtent_Min = _get_value('data_verticalextent'+str(i)+'_min', lst_name, sh, 'string')
        e, Data_VerticalExtent_Max = _get_value('data_verticalextent'+str(i)+'_max', lst_name, sh, 'string')
        e, Data_VerticalExtent_Unit = _get_value('data_verticalextent'+str(i)+'_unit', lst_name, sh, 'string')
        e, Data_VerticalExtent_Ref = _get_value('data_verticalextent'+str(i)+'_ref', lst_name, sh, 'string')
    ...
    # Data_DistFormat
    for i in range(1, 20):
        e, Data_DistFormatName = _get_value('data_distformat'+str(i)+'_name', lst_name, sh, 'string')
        Data_DistFormatName = _encodexml(Data_DistFormatName)
        e, Data_DistFormatVersion = _get_value('data_distformat'+str(i)+'_version', lst_name, sh, 'string')
        Data_DistFormatVersion = _encodexml(Data_DistFormatVersion)
        e, Data_DistFormatSpecification = _get_value('data_distformat'+str(i)+'_specification', lst_name, sh, 'string')
    ...
    # Data_Linkage (url)
    for i in range(1, 20):
        e, Data_LinkageName = _get_value('data_linkage'+str(i)+'_name', lst_name, sh, 'string')
        Data_LinkageName = _encodexml(Data_LinkageName)
        e, Data_LinkageDescription = _get_value('data_linkage'+str(i)+'_description', lst_name, sh, 'string')
        Data_LinkageDescription = _encodexml(Data_LinkageDescription)
        e, Data_LinkageURL = _get_value('data_linkage'+str(i)+'_url', lst_name, sh, 'string')
        Data_LinkageURL = _encodexml(Data_LinkageURL)
        e, Data_LinkageProtocol = _get_value('data_linkage'+str(i)+'_protocol', lst_name, sh, 'string')
    ...
    # DQ_Level
    e, Data_DQ_Level = _get_value('data_dq_level', lst_name, sh, 'string')
    ...
    for i in range(1, 20):
        e, Data_DQ_InspireConformityId = _get_value('data_dq_inspireconformity'+str(i)+'_id', lst_name, sh, 'integer')
        e, Data_DQ_InspireConformityTest = _get_value('data_dq_inspireconformity'+str(i)+'_specification', lst_name, sh, 'string')
        if Data_DQ_InspireConformityTest: Data_DQ_InspireConformityTest = Data_DQ_InspireConformityTest.split()[0]
        e, Data_DQ_InspireConformityDateCreation = _get_value('data_dq_inspireconformity'+str(i)+'_datecreation', lst_name, sh, 'date')
        e, Data_DQ_InspireConformityDatePublication = _get_value('data_dq_inspireconformity'+str(i)+'_datepublication', lst_name, sh, 'date')
        e, Data_DQ_InspireConformityDateRevision = _get_value('data_dq_inspireconformity'+str(i)+'_daterevision', lst_name, sh, 'date')
        e, Data_DQ_InspireConformityResult = _get_value('data_dq_inspireconformity'+str(i)+'_explain', lst_name, sh, 'string')
        Data_DQ_InspireConformityResult = _encodexml(Data_DQ_InspireConformityResult)
        e, Data_DQ_InspireConformityPass = _get_value('data_dq_inspireconformity'+str(i)+'_pass', lst_name, sh, 'string')
    ...
    for i in range(1, 20):
        e, Data_DQ_ConformityTest = _get_value('data_dq_conformity'+str(i)+'_specification', lst_name, sh, 'string')
        Data_DQ_ConformityTest = _encodexml(Data_DQ_ConformityTest)
        e, Data_DQ_ConformityDateCreation = _get_value('data_dq_conformity'+str(i)+'_datecreation', lst_name, sh, 'date')
        e, Data_DQ_ConformityDatePublication = _get_value('data_dq_conformity'+str(i)+'_datepublication', lst_name, sh, 'date')
        e, Data_DQ_ConformityDateRevision = _get_value('data_dq_conformity'+str(i)+'_daterevision', lst_name, sh, 'date')
        e, Data_DQ_ConformityResult = _get_value('data_dq_conformity'+str(i)+'_explain', lst_name, sh, 'string')
        Data_DQ_ConformityResult = _encodexml(Data_DQ_ConformityResult)
        e, Data_DQ_ConformityPass = _get_value('data_dq_conformity'+str(i)+'_pass', lst_name, sh, 'string')
    ...
    # LI_Statement
    e, LI_Statement = _get_value('li_statement', lst_name, sh, 'string')
    ...
    # LI_ProcessStep
    e, LI_ProcessStep = _get_value('li_processstep', lst_name, sh, 'string')
    ...
    # LI_Source
    e, LI_Source = _get_value('li_source', lst_name, sh, 'string')
...
# _get_value
# ------------------------------------------------------------------------------
def _get_xlsx_value(cell = '', lst_name = {}, sh = {}, type = 'string'):
    pass
...
def _get_xls_value(cell = '', lst_name = {}, sh = {}, type = 'string'):
    ...
    if cell and cell in lst_name:
        try:
            ...
            type = lst_name[cell][0].cell().ctype
            #print type
        except:
