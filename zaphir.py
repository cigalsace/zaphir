...
class Zaphir_Window(Frame):
    ...
    def CreateWidgets(self):
        ...
        # Frame 6: info
        self.lb_info = Label(self.frame_info, text="G. Ryckelynck (Partenariat CIGAL - 2011)", fg="#666", font="Helvetica 8 normal italic")
    ...
    def help(self):
        ...
        self.txt_messages.insert(END, u"Application développée par G. Ryckelynck - Partenariat CIGAL 2011 (www.cigalsace.org)\n")
